...
sources.concat(whitelist).forEach(function(source) {
    ...
    var supportedProjection = source.available_projections &&
        source.available_projections.some(function(projection) {
            return supportedWMSProjections.some(function(supportedProjection) {
              return supportedProjection === projection;
            })
        });
    if (source.type === 'wms' && !supportedProjection) return;
